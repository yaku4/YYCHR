...
public class FillEllipse : EditFunctionBase
{
	public FillEllipse()
	{
		base.Name = ResourceUtility.GetResourceString(EditFunctionBase.ResourceType, "Resources.PenNameFillEllipse");
		base.Icon = Resources.PenIconFillEllipse;
		base.RectType = true;
	}
	...
	public override void MouseMove(Bytemap bytemap, Point mousePoint, MouseButtons mouseButtons)
	{
		...
		if ((mMouseButtons & MouseButtons.Left) == MouseButtons.Left)
		{
			...
			editingBytemap.FillCircle(l, t, num + 1, num2 + 1, mSelectedPalette);
		}
	...
	public override void MouseUp(Bytemap bytemap, Point mouseUpPoint, MouseButtons mouseButtons)
	{
		if ((mMouseButtons & MouseButtons.Left) == MouseButtons.Left && mouseButtons == MouseButtons.Left)
		{
			...
			bytemap.FillCircle(l, t, num + 1, num2 + 1, mSelectedPalette);
