...
public class MsgBoxDialog : Form
{
	...
	private void SetupText(string text)
	{
		...
		Size size = TextRenderer.MeasureText(text, Font, proposedSize, TextFormatFlags.TextBoxControl);
		Size size2 = TextRenderer.MeasureText("\n\n\n", Font, proposedSize, TextFormatFlags.TextBoxControl);
		int num = Screen.PrimaryScreen.Bounds.Width * 3 / 4;
		int num2 = Screen.PrimaryScreen.Bounds.Height * 3 / 4;
		int num3 = size.Width;
		...
		int num7 = base.Width - textBoxMessage.Width + num3;
		int num8 = base.Height - textBoxMessage.Height + num4;
	...
	{
		System.ComponentModel.ComponentResourceManager componentResourceManager = new System.ComponentModel.ComponentResourceManager(typeof(PrgEditor.Forms.MsgBoxDialog));
