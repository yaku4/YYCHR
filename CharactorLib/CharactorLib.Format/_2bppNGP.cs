...
public class _2bppNGP : FormatBase
{
	public _2bppNGP()
	{
		base.FormatText = "[8*2]";
		base.Name = "2BPP NGP";
		base.Extension = "ngp,npc,ngc";
		base.Author = "Yy";
		base.Url = "";
		base.Readonly = false;
